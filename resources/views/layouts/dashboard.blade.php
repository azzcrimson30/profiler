            ...
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="#" style="opacity:0.5;pointer-events:none;">
                        ...
                        Module A <small style="color:var(--text-muted);font-size:0.65rem;margin-left:auto;">Soon</small>
                    </a>
                </li>
                <li>
                    <a href="#" style="opacity:0.5;pointer-events:none;">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                        Module B <small style="color:var(--text-muted);font-size:0.65rem;margin-left:auto;">Soon</small>
                    </a>
                </li>
                <li>
                    <a href="#" style="opacity:0.5;pointer-events:none;">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20V10"/><path d="M18 20V4"/><path d="M6 20v-4"/></svg>
                        Module C <small style="color:var(--text-muted);font-size:0.65rem;margin-left:auto;">Soon</small>
                    </a>
                </li>
            </ul>
        </div>
